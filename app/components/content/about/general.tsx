    ...
    <section className="max-w-7xl w-full px-4 lg:px-16 text-brand-gray-lavender flex flex-col gap-10 lg:gap-16 lg:text-3xl mt-10 lg:mt-28">
      <div className="flex flex-col gap-2">
        ...
        <p className="leading-normal lg:leading-11">
          ReactJS Indonesia: Komunitas Developer React dan React Native Terbesar
          di Indonesia
        </p>
      </div>
      <p className="text-lg lg:text-2xl leading-normal lg:leading-10">
        ReactJS Indonesia adalah komunitas yang didedikasikan untuk developer
        React dan React Native di Indonesia. Kami bertujuan untuk menghubungkan,
      ...
      <div className="flex flex-col lg:flex-row lg:max-w-5xl w-full justify-between gap-8">
        <div className="flex flex-col gap-1">
          ...
          <p className="leading-normal lg:leading-10">Member grup Telegram</p>
        </div>
