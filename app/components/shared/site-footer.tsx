...
export function SiteFooter() {
  return (
    <footer className="container flex-col mx-auto gap-14">
      <div className="flex items-center justify-between">
        <img className="w-[67.44px] h-[31.57px]" src="./images/logos/reactjsid.svg" alt="reactjsid-logo" />
        <Navigation className="gap-16" />
        <div className="flex items-center gap-8">
          {[siFacebook, siGithub, siTelegram, siX].map(({ title, path }) => <svg key={title}
            role="img"
